...
**Всё что ≤768px - это мобилка.** (единый брейкпоинт из styles.md)

**Брейкпоинт:** `@media (pointer: coarse)` — по типу устройства (тачскрин)

**Альтернатива:** `@media (max-width: 768px)` — для десктопных браузеров с узким окном
