...
- ✅ **Таблица "Приход" (IncomeTable.vue) модернизирована (13.02.2026)**
  - Переведена на TanStack Table
  - Добавлены кнопки управления (Просмотр, Удалить, Фильтры, Обновить)
  - Реализована сортировка по всем колонкам
  - Выбор строки по клику (без checkbox)
  - Фильтрация по клиенту и категории
  - Выбор месяца для отображения данных
  - "Всего за месяц" перенесено ПОСЛЕ таблицы
  - ViewIncomeModal с полной информацией о заказе и приёмом платежей
  - Задеплоено на BeGet
