...
**Использованы существующие переменные:**
- `--generalTextColor` - текст ячеек
- `--text-colorAlert` - failed-booking, empty-state

**Обновлён tables.css:** все жёстко заданные цвета заменены на переменные

### Пункт 2: Приведение таблиц к единым стилям ✅ ВЫПОЛНЕН
**Дата:** 13.02.2026

**Проверены все таблицы в проекте:**
| Компонент | table-general | table-scroll-container | accounting-table | Статус |
|-----------|---------------|----------------------|-----------------|--------|
| BookingsCalendar.vue | ✅ | ✅ | ✅ | Готово |
| IncomeTable.vue | ✅ | ✅ | ✅ | Готово |
| ExpensesTable.vue | ✅ | ✅ | ✅ | Готово |
| Accounting.vue | - | - | - | Контейнер |

**Все таблицы уже используют единый шаблон стилей!**

### Правило ✅ СОБЛЮДЕНО
- Записано в память после успешного выполнения пункта 1 и 2